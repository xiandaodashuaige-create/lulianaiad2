        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          服务覆盖新加坡、马来西亚、香港、澳门、中国大陆、台湾的同城AI获客专家。结合顶级算法与本地化运营，让每一分广告预算都带来真实的生意增长。
            ...
            <div className="flex gap-4">
              <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex flex-col">
                ...
                <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#25D366] transition-colors font-medium">
                  +60 10-651 9843
                </a>
              </li>
